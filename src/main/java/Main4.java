...
public class Main4 {
    public static void main(String[] args) throws JoseException, MalformedClaimException, InvalidJwtException {
        //
...
//        claims.setStringListClaim("groups", groups); // multi-valued claims work too and will end up as a JSON array
        ...
        System.err.println(rsaJsonWebKey.getKey());
        System.err.println(rsaJsonWebKey1.getKey());
